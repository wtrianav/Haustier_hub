        ...
        <section className="showcase" id="showcase">
            <div className="container-fluid p-0">
                <div className="row g-0">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{ backgroundImage: `url('images/photos/veterinarian-2.jpg')` }}></div>
                ...
                <div className="row g-0">
                    <div className="col-lg-6 text-white showcase-img" style={{ backgroundImage: `url('images/photos/veterinarian-25.jpg')` }}></div>
                ...
                <div className="row g-0">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{ backgroundImage: `url('images/photos/veterinarian-19.jpg')` }}></div>
                    <div className="col-lg-6 order-lg-1 my-auto showcase-text">
